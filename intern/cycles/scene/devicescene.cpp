...
DeviceScene::DeviceScene(Device *device)
    : bvh_nodes(device, "bvh_nodes", MEM_GLOBAL),
      ...
      spoly_caster_object_index(device, "spoly_caster_object_index", MEM_GLOBAL),
      spoly_caster_tree_offset(device, "spoly_caster_tree_offset", MEM_GLOBAL),
      spoly_tree_nodes(device, "spoly_tree_nodes", MEM_GLOBAL),

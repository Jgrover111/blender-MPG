...
DeviceScene::DeviceScene(Device *device)
    : bvh_nodes(device, "bvh_nodes", MEM_GLOBAL),
      ...
      caustic_caster_object_index(device, "caustic_caster_object_index", MEM_GLOBAL),
      caustic_caster_prim_offset(device, "caustic_caster_prim_offset", MEM_GLOBAL),
      caustic_caster_num_prims(device, "caustic_caster_num_prims", MEM_GLOBAL),

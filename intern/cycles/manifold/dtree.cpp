 ...
 * (Mitsuba has no dtree.cpp as it's header-only template code)
 *
 * Implementation of GuideSummary estimation from OpenPGL distributions.
 * See dtree.h for architectural notes.
 */
